...
def get_arcball_quaternion(arcball_center, mouse1, mouse2, screen_height, quaternion):
    ...
    m1 = Vector3(mouse1[0] - arcball_screen_center[0], (screen_height - 1) - mouse1[1] - arcball_screen_center[1], 0)
    m2 = Vector3(mouse2[0] - arcball_screen_center[0], (screen_height - 1) - mouse2[1] - arcball_screen_center[1], 0)

    # calculate the z coordinates of the mouse positions on the arcball
    m1[2] = ARCBALL_RADIUS ** 2 - m1[0] ** 2. - m1[1] ** 2.
    m2[2] = ARCBALL_RADIUS ** 2 - m2[0] ** 2. - m2[1] ** 2.
    ...
    new_quaternion = (old_w * new_w - old_c.dot(new_c),
            new_c * old_w + old_c * new_w + new_c.cross(old_c))
